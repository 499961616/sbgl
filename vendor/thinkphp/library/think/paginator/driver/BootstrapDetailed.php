    ...
    protected  function gopage()
    {
        ...
        return $gotohtml="<li>
                    <form action='' method='get' >
                        <a style='float:left;margin-left:2px;'><input style='height:25px; width: 90px' type='text' name='page' placeholder='请选择页数'> 
                            <input style='height:25px;' type='submit' value='确定'> 
                        </a>
                    </form>
                    </li>";
    }
